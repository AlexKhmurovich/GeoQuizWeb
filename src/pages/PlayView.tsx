    ...
    switch (modeQ) {
      ...
      case "Capitals":
        return (
          <h1
            className={
              (gameOver ? "hidden " : "block ") + "text-2xl font-semibold"
            }
          >
    ...
    <div className="flex items-center justify-center h-full p-4 sm:p-8 ">
      <div className="flex flex-col items-center w-full h-full">
        <div className="flex justify-between items-center w-full">
          ...
          <h1 className="text-xl sm:text-2xl font-bold m-2">{props.mode}</h1>
        ...
        >
          ...
          <div className="space-y-4">
                ...
                <div className="flex w-100 space-x-4">
                  <div className="flex-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Shapes">Shape</SelectItem>
                        <SelectItem value="Anthems">Anthem</SelectItem>
                        <SelectItem value="Countries">Country</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Capitals">Capital</SelectItem>
            ...
            <div className="text-left">
              <Label htmlFor="numQuestions" className="text-gray-700 text-left">
                Number of Questions
              </Label>
              <Input
                id="numQuestions"
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center">
                ...
                />
                <Label htmlFor="penalizeWrong" className="text-gray-700 ml-2">
                  -1 for mistakes
                </Label>
              </div>
              ...
              {(props.mode == "Flags" ||
                ...
                <div className="flex items-center">
                  <Switch
                    id="blinkModeToggle"
                    checked={blinkMode}
                    onCheckedChange={(checked) => setBlinkMode(checked)}
                  />
                  <Label
              ...
              {blinkMode && (
                <div className="text-left">
                  ...
                  <Input
                    ...
                    min="1"
                    value={blinkTimer}
                    onChange={(e) => setBlinkTimer(parseFloat(e.target.value))}
                    className="bg-white border-gray-300 text-gray-800 placeholder-gray-400 mt-1"
                  />
                </div>
              )}
        ...
        >
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="text-gray-600">
              {Math.round((amountCorrect / Number(question)) * 100)}% accuracy
            </div>
          </div>
        ...
        >
          ...
          <div className="w-full max-w-md mt-4 mb-2">
            <div
              className={
                "flex flex-col w-full justify-between " + (gameOver ? "" : " ")
              }
            >
              <div
                className={
            ...
            <Input
              ...
              className={(gameOver ? "hidden " : "block ") + "bg-white mt-2"}
            />
          </div>
          <Button
            className={gameOver ? "hidden" : "block"}
